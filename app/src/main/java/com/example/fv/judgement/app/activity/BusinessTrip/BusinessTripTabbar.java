...
public class BusinessTripTabbar extends BaseBottomTabActivity implements OnBottomDragListener {
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, com.example.fv.judgement.app.activity.BusinessTrip.BusinessTripTabbar.class);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_businesstrip_tabbar, this);
    ...
    protected Fragment getFragment(int position) {
        switch (position) {
            case 0:
                return BusinessTripWaitList.createInstance(BusinessTripWaitList.RANGE_ALL);
            default:
                return BusinessTripRecordList.createInstance(BusinessTripRecordList.RANGE_ALL);
        }
    };

    //	private static final String[] TAB_NAMES = {"主页", "消息", "发现", "设置"};
    private static final String[] TAB_NAMES = {"待申请", "出差记录"};
    @Override
