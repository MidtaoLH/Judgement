...
public class ApplyEditAdapter extends BaseAdapter {

    private Context context;
    private List<MdlExamineEditDetail> products;
    private String dataType;

    public ApplyEditAdapter(Context context, List<MdlExamineEditDetail> products,String DataType) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        // 获取小布局
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.applyeditlist, null);
        }
