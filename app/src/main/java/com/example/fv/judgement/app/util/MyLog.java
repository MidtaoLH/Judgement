...
public class MyLog {
     ...
     * @param text
     */
    public static void writeLogtoFile(String mylogtype, String lmname,String fsname, String text,String type) {// 新建或打开日志文件
        /*Date nowtime = new Date();
        String needWriteFiel = logfile.format(nowtime);
        String needWriteMessage = myLogSdf.format(nowtime) + "    " + mylogtype + "    " + lmname + "    " + text;
